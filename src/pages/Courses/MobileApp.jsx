...
const MobileApp = () => {
  ...
  description="Learn Android and Mobile App Development professionally."
  keywords="Mobile app development Jaipur"
  url="https://piimtedtech.in/mobile-app-development"
/>
            ...
            <div className="row">
              ...
              <div className="col-lg-3 mb-4">
                <div className="sidebar shadow px-3 pb-3">
                  <div className="nav flex-column nav-pills">
                    ...
                    <Link to="/mobile-app-development" className="nav-link btn-warning text-white mt-3 p-3 active">
              ...
              <div className="col-lg-9">
                <div className="course-content bg-white p-5 mb-5 rounded shadow">
                  ...
                  <img src="assets/image/mobile-app-development-trends.webp" className="img-fluid rounded my-4" alt="Mobile App Development Course at PIIMT Edtech" />

                  <p><strong>Design and ship Android and iOS apps using the most in-demand cross-platform frameworks.!</strong></p>



                  <ul className="list-unstyled">
                    <li className="mb-2 d-flex"><i className="fa-solid fa-diamond me-3 mt-1" style={{ color: '#d35400', fontSize: '0.8rem' }}></i> <span><strong>Courses Covered:</strong> Flutter App Development, React Native App Development</span></li>
                    <li className="mb-2 d-flex"><i className="fa-solid fa-diamond me-3 mt-1" style={{ color: '#d35400', fontSize: '0.8rem' }}></i> <span><strong>Who This Is For:</strong> Developers expanding into mobile, entrepreneurs with app ideas, graduates targeting the mobile development job market</span></li>
                    <li className="mb-2 d-flex"><i className="fa-solid fa-diamond me-3 mt-1" style={{ color: '#d35400', fontSize: '0.8rem' }}></i> <span><strong>Flutter Track:</strong> Dart programming, Flutter widgets and UI, state management, API integration, publishing to Google Play and App Store</span></li>
                    <li className="mb-2 d-flex"><i className="fa-solid fa-diamond me-3 mt-1" style={{ color: '#d35400', fontSize: '0.8rem' }}></i> <span><strong>React Native Track:</strong> JavaScript and React fundamentals, navigation, REST API integration, device features (camera, GPS), testing and deployment</span></li>
                    <li className="mb-2 d-flex"><i className="fa-solid fa-diamond me-3 mt-1" style={{ color: '#d35400', fontSize: '0.8rem' }}></i> <span><strong>Format:</strong> Students build a complete, functional mobile app as their final project</span></li>
                    <li className="mb-2 d-flex"><i className="fa-solid fa-diamond me-3 mt-1" style={{ color: '#d35400', fontSize: '0.8rem' }}></i> <span><strong>Outcome:</strong> A published or portfolio-ready mobile app demonstrating real-world capability</span></li>
                    <li className="mb-3 d-flex"><i className="fa-solid fa-diamond me-3 mt-1" style={{ color: '#d35400', fontSize: '0.8rem' }}></i> <span><strong>Duration:</strong> 3 to 4 months per framework</span></li>
                  </ul>
                  <p className="small mt-3" style={{ color: '#d35400' }}><strong><i className="bi bi-pin-angle-fill"></i> Primary Keywords:</strong> <span className="text-muted italic">Flutter course Jaipur, React Native training Rajasthan, mobile app development course Sikar</span></p>
