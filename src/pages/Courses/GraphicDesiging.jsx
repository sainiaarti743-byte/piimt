                        ...
                        <div className="row">
                            <div className="col-lg-3 mb-4">
                                <div className="sidebar shadow px-3 pb-3">
                                    <div className="nav flex-column nav-pills">
                                        ...
                                        <Link to="/graphic-desiging" className="nav-link btn-warning text-white mt-3 p-3 active">
                                            Graphic Designing
                                        </Link>
                            ...
                            <div className="col-lg-9">
                                <div className="course-content bg-white p-5 mb-5 rounded shadow">
                                    <h4 className="fw-bold">Graphic Designing</h4>
                                    <img src="assets/image/graphics-design.jpg" className="img-fluid rounded my-4" alt="Graphic Designing at PIIMT EdtechSoftware Solutions" />

                                    <p><strong>Turn creative ideas into professional visuals — for brands, media, and digital platforms</strong></p>
                                    ...
                                    <ul className="list-unstyled mt-2">
                                        ...
                                        <li className="mb-3 d-flex align-items-start">
                                            ...
                                            <span className="fs-5 text-dark">
                                                <strong>Courses Covered:</strong> Graphic Designing — Photoshop, Illustrator, CorelDraw, InDesign
                                            </span>
                                        </li>
                                        ...
                                        <li className="mb-3 d-flex align-items-start">
                                            <i className="fa-solid fa-diamond me-3 mt-1" style={{ color: '#fd7e14', fontSize: '0.8rem' }}></i>
                                            <span className="fs-5 text-dark">
                                                <strong>Who This Is For:</strong> Creative individuals wanting a professional design career, marketing teams needing in-house design capability, freelancers offering brand identity services
                                            </span>
                                        </li>
                                        ...
                                        <li className="mb-3 d-flex align-items-start">
                                            <i className="fa-solid fa-diamond me-3 mt-1" style={{ color: '#fd7e14', fontSize: '0.8rem' }}></i>
                                            <span className="fs-5 text-dark">
                                                <strong>What You Will Learn:</strong> Adobe Photoshop for photo editing and compositing, Illustrator for vector-based logo work, CorelDraw for layout and print design, typography principles and colour theory, brand identity design, social media creatives, packaging and poster design
                                            </span>
                                        </li>
                                        ...
                                        <li className="mb-3 d-flex align-items-start">
                                            <i className="fa-solid fa-diamond me-3 mt-1" style={{ color: '#fd7e14', fontSize: '0.8rem' }}></i>
                                            <span className="fs-5 text-dark">
                                                <strong>Format:</strong> Design briefs and client simulation projects — students work like designers from day one
                                            </span>
                                        </li>
                                        ...
                                        <li className="mb-3 d-flex align-items-start">
                                            <i className="fa-solid fa-diamond me-3 mt-1" style={{ color: '#fd7e14', fontSize: '0.8rem' }}></i>
                                            <span className="fs-5 text-dark">
                                                <strong>Outcome:</strong> A professional design portfolio of 10+ finished pieces across different categories
                                            </span>
                                        </li>
                                        ...
                                        <li className="mb-4 d-flex align-items-start">
                                            <i className="fa-solid fa-diamond me-3 mt-1" style={{ color: '#fd7e14', fontSize: '0.8rem' }}></i>
                                            <span className="fs-5 text-dark">
                                                <strong>Duration:</strong> 3 to 4 months | Flexible batch timings available
                                            </span>
                                        </li>
                                    </ul>
                                    ...
                                    <p className="mt-4 small">
                                        ...
                                        <span className="text-muted italic">graphic design course Jaipur, Photoshop training Sikar, Illustrator course Rajasthan</span>
                                    </p>
