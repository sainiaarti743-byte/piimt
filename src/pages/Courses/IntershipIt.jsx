                        ...
                        <div className="row">
                            <div className="col-lg-3 mb-4">
                                <div className="sidebar shadow px-3 pb-3">
                                    <div className="nav flex-column nav-pills">
                                        ...
                                        <Link to="/internship-it" className="nav-link btn-warning text-white mt-3 p-3 active">
                            ...
                            <div className="col-lg-9">
                                <div className="course-content bg-white p-5 mb-5 rounded shadow">
                                    <h4 className="fw-bold">IT Internship Programme</h4>
                                    <img src="assets/image/internship.jpg" className="img-fluid rounded my-4" alt="Internship in IT at PIIMT EdtechSoftware Solutions" />

                                    <p><strong>Get real-world experience before your first job — with live projects and professional mentorship.!</strong></p>
                                    ...
                                    <ul className="list-unstyled mt-2">
                                        ...
                                        <li className="mb-3 d-flex align-items-start">
                                            ...
                                            <span className="fs-5 text-dark">
                                                <strong>Programme Covered:</strong> Internship for IT Students — available across multiple technical domains
                                            </span>
                                        </li>
                                        ...
                                        <li className="mb-3 d-flex align-items-start">
                                            <i className="fa-solid fa-diamond me-3 mt-1" style={{ color: '#fd7e14', fontSize: '0.8rem' }}></i>
                                            <span className="fs-5 text-dark">
                                                <strong>Who This Is For:</strong> Final-year students and recent graduates wanting practical experience, PIIMT course completers wanting to apply their skills on live projects
                                            </span>
                                        </li>
                                        ...
                                        <li className="mb-3 d-flex align-items-start">
                                            <i className="fa-solid fa-diamond me-3 mt-1" style={{ color: '#fd7e14', fontSize: '0.8rem' }}></i>
                                            <span className="fs-5 text-dark">
                                                <strong>What Interns Do:</strong> Work on live client or in-house projects, participate in daily stand-ups and reviews, build work they can showcase in interviews, receive a formal internship certificate from PIIMT EdTech
                                            </span>
                                        </li>
                                        ...
                                        <li className="mb-3 d-flex align-items-start">
                                            <i className="fa-solid fa-diamond me-3 mt-1" style={{ color: '#fd7e14', fontSize: '0.8rem' }}></i>
                                            <span className="fs-5 text-dark">
                                                <strong>Domains Available:</strong> Web Development, Digital Marketing, Graphic Designing, Mobile App Development, Data Science, AI
                                            </span>
                                        </li>
                                        ...
                                        <li className="mb-3 d-flex align-items-start">
                                            <i className="fa-solid fa-diamond me-3 mt-1" style={{ color: '#fd7e14', fontSize: '0.8rem' }}></i>
                                            <span className="fs-5 text-dark">
                                                <strong>Duration:</strong> 1 to 3 months depending on domain and project
                                            </span>
                                        </li>
                                        ...
                                        <li className="mb-4 d-flex align-items-start">
                                            <i className="fa-solid fa-diamond me-3 mt-1" style={{ color: '#fd7e14', fontSize: '0.8rem' }}></i>
                                            <span className="fs-5 text-dark">
                                                <strong>Outcome:</strong> A portfolio entry, a professional reference, and practical experience that sets graduates apart in the job market
                                            </span>
                                        </li>
                                    </ul>
                                    ...
                                    <p className="mt-4 small">
                                        ...
                                        <span className="text-muted italic">IT internship Jaipur, internship programme Rajasthan, live project training Sikar</span>
                                    </p>

                                    <a href="registerd.html" className="btn btn-warning text-white btn-sm">Apply Now</a>
                                </div>
                            </div>
