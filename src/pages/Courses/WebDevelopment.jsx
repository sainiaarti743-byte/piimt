                        ...
                        <div className="row">
                            <div className="col-lg-3 mb-4">
                                <div className="sidebar shadow px-3 pb-3">
                                    <div className="nav flex-column nav-pills">
                                        ...
                                        <Link to="/web-development" className="nav-link btn-warning text-white mt-3 p-3 active">
                            ...
                            <div className="col-lg-9">
                                <div className="course-content bg-white p-5 mb-5 rounded shadow">
                                    <h4 className="fw-bold">Web Design & Development</h4>
                                    <img src="assets/image/website-devlopment.jpg" className="img-fluid rounded my-4 w-100" alt="" />
                                    <p><b>Build professional websites from scratch — front-end to back-end, design to deployment.</b></p>
                                    ...
                                    <ul className="list-unstyled mt-2">
                                        ...
                                        <li className="mb-3 d-flex align-items-start">
                                            ...
                                            <span className="fs-5 text-dark">
                                                <strong>Courses Covered:</strong> Website Design (HTML & CSS), Full-Stack Web Development (HTML, CSS, JavaScript, Bootstrap, PHP, MySQL), ASP.NET Development
                                            </span>
                                        </li>
                                        ...
                                        <li className="mb-3 d-flex align-items-start">
                                            <i className="fa-solid fa-diamond me-3 mt-1" style={{ color: '#fd7e14', fontSize: '0.8rem' }}></i>
                                            <span className="fs-5 text-dark">
                                                <strong>Who This Is For:</strong> Students who want to build websites professionally, freelancers, aspiring software developers, small business owners
                                            </span>
                                        </li>
                                        ...
                                        <li className="mb-3 d-flex align-items-start">
                                            <i className="fa-solid fa-diamond me-3 mt-1" style={{ color: '#fd7e14', fontSize: '0.8rem' }}></i>
                                            <span className="fs-5 text-dark">
                                                <strong>What You Will Learn:</strong> Structuring web pages with HTML5 and CSS3, making sites responsive with Bootstrap, writing interactive front-end logic in JavaScript, building database-driven back ends in PHP or ASP.NET, deploying sites to a live server
                                            </span>
                                        </li>
                                        ...
                                        <li className="mb-3 d-flex align-items-start">
                                            <i className="fa-solid fa-diamond me-3 mt-1" style={{ color: '#fd7e14', fontSize: '0.8rem' }}></i>
                                            <span className="fs-5 text-dark">
                                                <strong>Format:</strong> classNameroom and online sessions with dedicated lab hours for hands-on project work
                                            </span>
                                        </li>
                                        ...
                                        <li className="mb-3 d-flex align-items-start">
                                            <i className="fa-solid fa-diamond me-3 mt-1" style={{ color: '#fd7e14', fontSize: '0.8rem' }}></i>
                                            <span className="fs-5 text-dark">
                                                <strong>Outcome:</strong> Students complete at least two fully functional websites as part of their portfolio before graduating
                                            </span>
                                        </li>
                                        ...
                                        <li className="mb-0 d-flex align-items-start">
                                            <i className="fa-solid fa-diamond me-3 mt-1" style={{ color: '#fd7e14', fontSize: '0.8rem' }}></i>
                                            <span className="fs-5 text-dark">
                                                <strong>Duration:</strong> 3 to 6 months depending on course level | Online and offline batches
                                            </span>
                                        </li>
                                    </ul>
