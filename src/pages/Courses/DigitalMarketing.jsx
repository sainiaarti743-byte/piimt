...
/>
                        ...
                        <div className="row">
                            <div className="col-lg-3 mb-4">
                                <div className="sidebar shadow px-3 pb-3">
                                  <div className="nav flex-column nav-pills">
                                        ...
                                        <Link to="/digital-marketing" className="nav-link btn-warning text-white mt-3 p-3 active">
                            ...
                            <div className="col-lg-9">
                                <div className="course-content bg-white p-5 mb-5 rounded shadow">
                                    <h4 className="fw-bold">Digital Marketing & SEO</h4>
                                    <img src="assets/image/digital-marketing.avif" className="img-fluid rounded my-4" alt="Digital Marketing at PIIMT EdtechSoftware Solutions"/>

                                        <p><strong>Reach customers online — through search engines, social media, email and paid advertising</strong></p>
                                        ...
                                        <ul className="list-unstyled mt-2">
                                            ...
                                            <li className="mb-3 d-flex align-items-start">
                                                ...
                                                <span className="fs-5 text-dark">
                                                    <strong>Courses Covered:</strong> Digital Marketing & SEO — comprehensive 6-month programme
                                                </span>
                                            </li>
                                            ...
                                            <li className="mb-3 d-flex align-items-start">
                                                <i className="fa-solid fa-diamond me-3 mt-1"  style={{color: '#fd7e14', fontSize: '0.8rem'}}></i>
                                                <span className="fs-5 text-dark">
                                                    <strong>Who This Is For:</strong> Marketing professionals shifting to digital, entrepreneurs, graduates, freelancers wanting to offer marketing services
                                                </span>
                                            </li>
                                            ...
                                            <li className="mb-3 d-flex align-items-start">
                                                <i className="fa-solid fa-diamond me-3 mt-1"  style={{color: '#fd7e14', fontSize: '0.8rem'}}></i>
                                                <span className="fs-5 text-dark">
                                                    <strong>What You Will Learn:</strong> On-page and off-page SEO, Google Ads and Meta Ads management, content marketing and copywriting, social media strategy, email marketing and automation, YouTube SEO, online reputation management
                                                </span>
                                            </li>
                                            ...
                                            <li className="mb-3 d-flex align-items-start">
                                                <i className="fa-solid fa-diamond me-3 mt-1"  style={{color: '#fd7e14', fontSize: '0.8rem'}}></i>
                                                <span className="fs-5 text-dark">
                                                    <strong>Tools You Will Use:</strong> Google Ads, Meta Business Suite, SEMrush, Ahrefs, Mailchimp, Canva, Google Analytics 4
                                                </span>
                                            </li>
                                            ...
                                            <li className="mb-3 d-flex align-items-start">
                                                <i className="fa-solid fa-diamond me-3 mt-1"  style={{color: '#fd7e14', fontSize: '0.8rem'}}></i>
                                                <span className="fs-5 text-dark">
                                                    <strong>Format:</strong> Live campaign practice on real ad accounts — not just classNameroom theory
                                                </span>
                                            </li>
                                            ...
                                            <li className="mb-3 d-flex align-items-start">
                                                <i className="fa-solid fa-diamond me-3 mt-1"  style={{color: '#fd7e14', fontSize: '0.8rem'}}></i>
                                                <span className="fs-5 text-dark">
                                                    <strong>Outcome:</strong> A personal digital marketing portfolio including real campaigns managed during training
                                                </span>
                                            </li>
                                            ...
                                            <li className="mb-4 d-flex align-items-start">
                                                <i className="fa-solid fa-diamond me-3 mt-1"  style={{color: '#fd7e14', fontSize: '0.8rem'}}></i>
                                                <span className="fs-5 text-dark">
                                                    <strong>Duration:</strong> 6 months | Online and offline batches available
                                                </span>
                                            </li>
                                        </ul>
                                        ...
                                        <p className="mt-4 small">
                                            ...
                                            <span className="text-muted italic">digital marketing course Jaipur, SEO training Rajasthan, Google Ads course Sikar</span>
                                        </p>
            ...
            <button type="button" className="btn btn-warning btn-lg rounded-circle" id="btn-back-to-top">
