                        ...
                        <div className="row">
                            <div className="col-lg-3 mb-4">
                                <div className="sidebar shadow px-3 pb-3">
                                    <div className="nav flex-column nav-pills">
                                        ...
                                        <Link to="/hardware-network" className="nav-link btn-warning text-white mt-3 p-3 active">
                                            Hardware & Networking
                                        </Link>
                            ...
                            <div className="col-lg-9">
                                <div className="course-content bg-white p-5 mb-5 rounded shadow">
                                    <h4 className="fw-bold">Hardware & Networking</h4>
                                    <img src="assets/image/hardware-network.jpg" className="img-fluid rounded my-4" alt="Hardware & Networking at PIIMT EdtechSoftware Solutions" />

                                    <p><strong>Build, manage and secure the infrastructure that keeps businesses connected.!</strong></p>

                                    <ul className="list-unstyled">
                                        <li className="mb-2 d-flex"><i className="fa-solid fa-diamond me-3 mt-1" style={{ color: '#e67e22', fontSize: '0.8rem' }}></i> <span><strong>Courses Covered:</strong> Hardware & Networking, Cyber Security (foundational)</span></li>
                                        <li className="mb-2 d-flex"><i className="fa-solid fa-diamond me-3 mt-1" style={{ color: '#e67e22', fontSize: '0.8rem' }}></i> <span><strong>Who This Is For:</strong> Students targeting IT support and network administration roles, engineers specialising in infrastructure, professionals pursuing CCNA-aligned skills</span></li>
                                        <li className="mb-2 d-flex"><i className="fa-solid fa-diamond me-3 mt-1" style={{ color: '#e67e22', fontSize: '0.8rem' }}></i> <span><strong>What You Will Learn:</strong> Computer hardware components and troubleshooting, OS installation and configuration, LAN and WAN setup, IP addressing and subnetting, router and switch configuration, server administration basics, introduction to cybersecurity principles</span></li>
                                        <li className="mb-2 d-flex"><i className="fa-solid fa-diamond me-3 mt-1" style={{ color: '#e67e22', fontSize: '0.8rem' }}></i> <span><strong>Format:</strong> Fully lab-based — students work with real hardware, cables, routers, and switches throughout the programme</span></li>
                                        <li className="mb-2 d-flex"><i className="fa-solid fa-diamond me-3 mt-1" style={{ color: '#e67e22', fontSize: '0.8rem' }}></i> <span><strong>Outcome:</strong> Graduates can set up, configure, and troubleshoot computer networks for small to medium businesses</span></li>
                                        <li className="mb-3 d-flex"><i className="fa-solid fa-diamond me-3 mt-1" style={{ color: '#e67e22', fontSize: '0.8rem' }}></i> <span><strong>Duration:</strong> 3 to 6 months depending on depth of specialisation</span></li>
                                    </ul>
                                    <p className="small mt-3" style={{ color: '#e67e22' }}><strong><i className="bi bi-pin-angle-fill"></i> Primary Keywords:</strong> <span className="text-secondary italic">hardware networking course Jaipur, CCNA training Rajasthan, computer networking institute Sikar</span></p>
