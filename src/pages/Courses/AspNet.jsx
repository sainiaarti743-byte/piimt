...
const AspNet = () => {
    return (
        ...
        <SEO
  title="ASP.NET Development Course"
  description="Professional ASP.NET development training with practical learning."
  keywords="ASP.NET training Jaipur"
  url="https://piimtedtech.in/asp-net-development"
/>
                        ...
                        <div className="row">
                            <div className="col-lg-3 mb-4">
                                <div className="sidebar shadow px-3 pb-3">
                                    <div className="nav flex-column nav-pills">
                                        ...
                                        <Link to="/asp-net-development" className="nav-link btn-warning text-white mt-3 p-3 active">
                                            ASP.NET Development
                                        </Link>
                            ...
                            <div className="col-lg-9">
                                <div className="course-content bg-white p-5 mb-5 rounded shadow">
                                    <h4 className="fw-bold">ASP.NET & C# Web Development</h4>
                                    <img src="assets/image/asp.svg" className="img-fluid rounded my-4" alt="ASP.NET Development at PIIMT EdtechSoftware Solutions" />

                                    <p><strong>Build secure, scalable enterprise web applications using Microsoft's powerful .NET framework.</strong></p>
                                    ...
                                    <ul className="list-unstyled mt-2">
                                        ...
                                        <li className="mb-3 d-flex align-items-start">
                                            ...
                                            <span className="fs-5 text-dark">
                                                <strong>Courses Covered:</strong> ASP.NET Development with C#
                                            </span>
                                        </li>
                                        ...
                                        <li className="mb-3 d-flex align-items-start">
                                            <i className="fa-solid fa-diamond me-3 mt-1" style={{ color: '#fd7e14', fontSize: '0.8rem' }}></i>
                                            <span className="fs-5 text-dark">
                                                <strong>Who This Is For:</strong> Developers targeting enterprise software roles, students wanting to specialise in Microsoft stack development, IT professionals in companies that run .NET-based systems
                                            </span>
                                        </li>
                                        ...
                                        <li className="mb-3 d-flex align-items-start">
                                            <i className="fa-solid fa-diamond me-3 mt-1" style={{ color: '#fd7e14', fontSize: '0.8rem' }}></i>
                                            <span className="fs-5 text-dark">
                                                <strong>What You Will Learn:</strong> C# programming fundamentals, ASP.NET MVC architecture, Entity Framework and database integration, user authentication and role management, building RESTful APIs in .NET, deploying ASP.NET applications to IIS and Azure
                                            </span>
                                        </li>
                                        ...
                                        <li className="mb-3 d-flex align-items-start">
                                            <i className="fa-solid fa-diamond me-3 mt-1" style={{ color: '#fd7e14', fontSize: '0.8rem' }}></i>
                                            <span className="fs-5 text-dark">
                                                <strong>Format:</strong> Project-led — students build and deploy a complete enterprise-grade web application
                                            </span>
                                        </li>
                                        ...
                                        <li className="mb-3 d-flex align-items-start">
                                            <i className="fa-solid fa-diamond me-3 mt-1" style={{ color: '#fd7e14', fontSize: '0.8rem' }}></i>
                                            <span className="fs-5 text-dark">
                                                <strong>Outcome:</strong> Ability to develop and maintain production-ready .NET applications for real business environments
                                            </span>
                                        </li>
                                        ...
                                        <li className="mb-4 d-flex align-items-start">
                                            <i className="fa-solid fa-diamond me-3 mt-1" style={{ color: '#fd7e14', fontSize: '0.8rem' }}></i>
                                            <span className="fs-5 text-dark">
                                                <strong>Duration:</strong> 3 to 4 months
                                            </span>
                                        </li>
                                    </ul>
                                    ...
                                    <p className="mt-4 small">
                                        ...
                                        <span className="text-muted italic">ASP.NET course Jaipur, C# training India, .NET developer course Rajasthan</span>
                                    </p>
