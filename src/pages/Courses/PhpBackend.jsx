...
const PhpBackend = () => {
    ...
    return (
        ...
        <SEO
  title="PHP Laravel Training in Jaipur"
  description="Learn PHP and Laravel backend development with live projects."
  keywords="PHP course Jaipur, Laravel training"
  url="https://piimtedtech.in/php-backend-development"
/>
                        ...
                        <div className="row">
                            <div className="col-lg-3 mb-4">
                                <div className="sidebar shadow px-3 pb-3">
                                    <div className="nav flex-column nav-pills">
                                        ...
                                        <Link to="/php-backend-development" className="nav-link btn-warning text-white mt-3 p-3 active">
                            ...
                            <div className="col-lg-9">
                                <div className="course-content bg-white p-5 mb-5 rounded shadow">
                                    <h4 className="fw-bold">PHP Native Development</h4>
                                    <img src="assets/image/php.jpg" className="img-fluid rounded my-4" alt="PHP Native Development at PIIMT EdtechSoftware Solutions" />

                                    <p><strong>Build the server-side logic that powers dynamic, data-driven web applications.</strong></p>
                                    ...
                                    <ul className="list-unstyled mt-2">
                                        ...
                                        <li className="mb-3 d-flex align-items-start">
                                            ...
                                            <span className="fs-5 text-dark">
                                                <strong>Courses Covered:</strong> PHP Native Development
                                            </span>
                                        </li>
                                        ...
                                        <li className="mb-3 d-flex align-items-start">
                                            <i className="fa-solid fa-diamond me-3 mt-1" style={{ color: '#fd7e14', fontSize: '0.8rem' }}></i>
                                            <span className="fs-5 text-dark">
                                                <strong>Who This Is For:</strong> Aspiring back-end developers, students who have completed HTML/CSS and want to add server-side capability, developers building web applications for businesses
                                            </span>
                                        </li>
                                        ...
                                        <li className="mb-3 d-flex align-items-start">
                                            <i className="fa-solid fa-diamond me-3 mt-1" style={{ color: '#fd7e14', fontSize: '0.8rem' }}></i>
                                            <span className="fs-5 text-dark">
                                                <strong>What You Will Learn:</strong> PHP syntax and programming fundamentals, MySQL database design and querying, CRUD operations and form handling, session management and authentication, MVC architecture principles, building a complete web application from database to browser
                                            </span>
                                        </li>
                                        ...
                                        <li className="mb-3 d-flex align-items-start">
                                            <i className="fa-solid fa-diamond me-3 mt-1" style={{ color: '#fd7e14', fontSize: '0.8rem' }}></i>
                                            <span className="fs-5 text-dark">
                                                <strong>Format:</strong> Project-based — students build a fully functional web application as their primary assessment
                                            </span>
                                        </li>
                                        ...
                                        <li className="mb-3 d-flex align-items-start">
                                            <i className="fa-solid fa-diamond me-3 mt-1" style={{ color: '#fd7e14', fontSize: '0.8rem' }}></i>
                                            <span className="fs-5 text-dark">
                                                <strong>Outcome:</strong> The ability to build and manage a dynamic database-driven website independently
                                            </span>
                                        </li>
                                    ...
                                    <p className="mt-4 small">
                                        ...
                                        <span className="text-muted italic">PHP course Jaipur, backend development training India, MySQL web development Rajasthan</span>
                                    </p>
